# Páginas de Desencriptación de HASH

## En caso de necesitar registro recuerda que puedes usar un correo temporal
* https://temp-mail.org/es/

## Identificar
* https://www.onlinehashcrack.com/hash-identification.php
* https://hashes.com/es/tools/hash_identifier
* https://www.dcode.fr/identificador-hash
* https://www.tunnelsup.com/hash-analyzer/
* https://suip.biz/?act=hashtag
* https://www.md5online.org/hash-identifier.html
* https://tools.prinsh.com/home/?tools=hashiden

## Desencriptación
* https://www.tools4noobs.com/online_tools/decrypt/
* https://xorbin.com/
* https://www.boxentriq.com/code-breaking/cryptogram
* https://magictool.ai/tool/decrypt-text/es/
* https://www.dcode.fr/en
* https://crackstation.net/
* https://superpatanegra.com/texto/
* https://www.davidquinones.dev/es/tools/encode-decode/null
* https://benjamin5252.github.io/web_crypto_api_example/
* https://codesandbox.io/s/front-end-file-encryption-using-web-crypto-api-vj0lf
